# Dynamic Bone Tree Copier

# Usage

Add the component to a GameObject in the scene.

Drag the GameObject containing the Dynamic Bone components you wish to copy into the field labeled "source".
